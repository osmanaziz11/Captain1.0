...
const ThemeModel = ({ title, children, handler }) => {
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center items-center bg-[#0c0c0cd5] w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0  h-full">
      <div className="relative w-[600px] max-h-full">
        <div className="relative bg-[#131212] rounded shadow-lg">
          <button
            type="button"
