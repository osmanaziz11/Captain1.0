      ...
      <div className="flex justify-center items-center flex-col   pb-10 transition  cursor-pointer">
        <div className="w-[370px] p-10 flex flex-col justify-center items-center  rounded h-[370px] bg-[#1b1b1b]  transition cursor-pointer">
          ...
          <div className="relative w-full  pe-2  ">
            <input
              type="text"
              className={`outline-none text-center bg-[#1b1b1b] text-gray-400 text-sm rounded block w-full pl-10 p-2.5 transition   placeholder-gray-400 `}
          ...
          <div className="relative w-full  pe-2  ">
            <input
              type="password"
              className={`outline-none text-center bg-[#1b1b1b] text-gray-300 text-sm rounded block w-full pl-10 p-2.5 transition   placeholder-gray-400 `}
